...
const CACHE_KEYS: Record<Exclude<PublicRefreshTarget, `global-market:${string}`>, string[]> = {
  ...
  "market-strategy-holdings": [
    "market-strategy:holdings-v1",
    "market:funds-breakdown-v1",
  ],
  "funds-breakdown": ["market:funds-breakdown-v1", "market:mf-top-holdings-v1"],
  "mf-top-holdings": ["market:mf-top-holdings-v1", "market:funds-breakdown-v1"],
